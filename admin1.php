...
">Hari</h6>
                ...
                <div class="navbar-nav w-100">
                    <a href="admin1" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    
                    <a href="rechargeRequests.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Recharge Request</a>
                       <a href="adwith.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>wihdraw Request</a>
        ...
        <div class="content">
            ...
            <br>
                    ...
                    <h2 style="font-size:20px;padding:5px; color:Black; text-align:center;"onclick="window.location.href='rechargeRequests.php'"> Click here to check recharge</h2>
...
">
                     <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="https://wa.me/">Contact Developer</a>                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                           
                            Designed By <a href="https://wa.me/">Hari</a>
